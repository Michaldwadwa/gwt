...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "projekt_gwt" because\n';
  ...
  $wnd.__gwt_activeModules['projekt_gwt'] = {
    'moduleName' : 'projekt_gwt',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/projekt_gwt.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['projekt_gwt'].superdevmode = true;

  var expectedSuffix = '/projekt_gwt.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + projekt_gwt + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:projekt_gwt';
  var devModeSessionKey = '__gwtDevModeSession:projekt_gwt';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/projekt_gwt/projekt_gwt.nocache.js';
  ...
  $wnd.__gwt_activeModules['projekt_gwt'].canRedirect = true;
  $wnd.__gwt_activeModules['projekt_gwt'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/projekt_gwt?user.agent=' + ua + '&_callback=' + callback;
